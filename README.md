...
> This documentation is also available as a PDF document generated using the abovementioned action. The PDF file can be found under [`docs/README.pdf`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/docs/README.pdf)
...
pypdf</code></pre>
  ...
  <li>
    Download <code>topdf</code> script:
    <pre style="white-space: pre-wrap; overflow-wrap: break-word; overflow-x: clip;"><code class="language-bash">curl -O https://raw.githubusercontent.com/IsraTech-Software/Markdown-PDF-Generator/refs/heads/main/topdf
chmod +x topdf</code></pre>
  </li>
  <li>
    Add the tool to your default environment path.
  </li>
</ol>
...
CSS demo files along with generated PDF files can be found under [`examples/`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples)
...
| - | - | - |
| `built-in` | The default stylesheet, built into the python script | [`Markdown`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/default/example.md); [`PDF`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/default/output.pdf) |
| [`Corporate Blue`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/corporate/styles.css) | Corporate-Style A4 Documentation | [`Markdown`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/corporate/example.md); [`PDF`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/corporate/output.pdf) |
| [`Formal Letter (A4)`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/formal-letter-a4/styles.css) | Formal A4 Letter (German "Anschreiben"), **requires HTML**. | [`Markdown`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/formal-letter-a4/example.md); [`PDF`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/formal-letter-a4/output.pdf) |
| [`Legal Contracts`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/legal-contract-de/styles.css) | German-Style legal contract with § Paragraphs, Absatz (Abs. / Subsection), Satz (S. / Sentences) and Nummer (Nr. / Numbered points) | [`Markdown`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/legal-contract-de/example.md); [`PDF`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/legal-contract-de/output.pdf) |
| [`Resume (CV)`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/cv/styles.css) | Professional CV-Template | [`Markdown`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/cv/example.md); [`PDF`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/cv/output.pdf) |
| `DL Envelope` | (\*) DL-Envelope - Please use the [`envelope` generation script](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/envelope-dl/envelope) (See section `Envelope Usage` below) | [`PDF`](https://github.com/IsraTech-Software/Markdown-PDF-Generator/tree/main/examples/envelope-dl/output.pdf) |
...
<ol>
  <li>
    ...
    <pre style="white-space: pre-wrap; overflow-wrap: break-word; overflow-x: clip;"><code class="language-bash">PyMuPDF
opencv-python
numpy
Pillow</code></pre>
  </li>
  <li>
    Download the <code>envelope</code> script:
    <pre style="white-space: pre-wrap; overflow-wrap: break-word; overflow-x: clip;"><code class="language-bash">curl -O https://raw.githubusercontent.com/IsraTech-Software/Markdown-PDF-Generator/refs/heads/main/examples/envelope-dl/envelope
chmod +x envelope</code></pre>
  </li>
  <li>
    Adjust the <code>envelope</code> script's properties to match your name and address:
    <pre style="white-space: pre-wrap; overflow-wrap: break-word; overflow-x: clip;"><code class="language-python"># Line 18
...
COMPANY: Dict[str, str] = {
  ...
  <li>
    Generate your first envelope:
    <pre style="white-space: pre-wrap; overflow-wrap: break-word; overflow-x: clip;"><code class="language-bash">envelope</code></pre>
  </li>
</ol>
